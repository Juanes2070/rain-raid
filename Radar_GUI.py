...
class Radar_Elements:
    def __init__(self, root, frame):
        ...
        #Default values
        w_path_def = r"D:\Downloads\SALIDA_RADAR"
        dat_path_def = r"D:\Downloads\20210301/"
        mask_path_def = r"D:\Documents\Estefa\Ensayo_ref_a_pp\Cuenca_Valle_Aburra\fill_med4/"
        ...
        self.left_frame = ttk.Frame(self.radar_frame)
        self.left_frame.grid(row='0',column='0',sticky='n')
        self.right_frame = ttk.Frame(self.radar_frame)
        self.right_frame.grid(row='1', column='0',sticky='n')


        self.download_ideam_frame = ttk.Frame(self.left_frame)
        self.download_ideam_frame.configure(height='100', width='120',borderwidth = '1', relief='ridge',padding='5')
        self.download_ideam_frame.grid(column='0', row='0')

        self.download_title = ttk.Label(self.download_ideam_frame)
        self.download_title.configure(text="Descarga-IDEAM")
        self.download_title.grid(row='0',column='0',columnspan='2')

        self.period_radar_label = ttk.Label(self.download_ideam_frame)
        self.period_radar_label.configure(text="Periodo de tiempo")
        self.period_radar_label.grid(row='1', column='0', sticky='w')

        self.start_date_entry = tkcalendar.DateEntry(self.download_ideam_frame,locale='es_ES',date_pattern='dd/MM/yyyy')
        self.start_date_entry.configure(width='22', textvariable=self.start_date)
        self.start_date_entry.grid(column='0', row='2', sticky='ew')

        self.end_date_entry = tkcalendar.DateEntry(self.download_ideam_frame,locale='es_ES',date_pattern='dd/MM/yyyy')
        ...
        self.interval_frame = ttk.Frame(self.download_ideam_frame)
        ...
        self.format_save_label = ttk.Label(self.download_ideam_frame)
        self.format_save_label.configure(text="Formato a guardar")
        self.format_save_label.grid(row='6', column='0',columnspan='2')

        self.save_raw_checkbox = tk.Checkbutton(self.download_ideam_frame)
        ...
        self.save_nc_checkbox = tk.Checkbutton(self.download_ideam_frame)
        ...
        self.save_tiff_checkbox = tk.Checkbutton(self.download_ideam_frame)
        ...
        self.interp_options_select = ttk.Combobox(self.download_ideam_frame)
        ...
        self.download_route_frame = ttk.Frame(self.download_ideam_frame)
        ...
        self.down_button = ttk.Button(self.download_ideam_frame)
        self.down_button.configure(text='Descargar')
        self.down_button.grid(column='0', row='10', sticky='ew', columnspan='2')

        # ---------------------------------------------------------------------------------------------------------------

        self.ref_to_pp_frame = ttk.Frame(self.right_frame)
        self.ref_to_pp_frame.configure(height='150', width='120', borderwidth='1', relief='ridge', padding='5')
        self.ref_to_pp_frame.grid(column='0', row='1', sticky='new')

        self.ref_to_pp_title = ttk.Label(self.ref_to_pp_frame)
        self.ref_to_pp_title.configure(text="Reflectividad a precipitación")
        self.ref_to_pp_title.grid(row='0', column='0', columnspan='3')

        self.in_ref_to_pp_folder_label = ttk.Label(self.ref_to_pp_frame)
        self.in_ref_to_pp_folder_label.configure(text="Carpeta de archivos nc")
        self.in_ref_to_pp_folder_label.grid(column='0', row='1')

        self.in_ref_to_pp_folder_entry = ttk.Entry(self.ref_to_pp_frame)
        ...
        self.lon_var_label = ttk.Label(self.ref_to_pp_frame)
        self.lon_var_label.configure(text="Longitud")
        self.lon_var_label.grid(column='0', row='3')

        self.lon_var_combo = ttk.Combobox(self.ref_to_pp_frame)
        ...
        self.ref_var_label = ttk.Label(self.ref_to_pp_frame)
        self.ref_var_label.configure(text="Reflectividad")
        self.ref_var_label.grid(column='0', row='4')

        self.ref_var_combo = ttk.Combobox(self.ref_to_pp_frame)
        ...
        self.out_ref_to_pp_folder_label = ttk.Label(self.ref_to_pp_frame)
        self.out_ref_to_pp_folder_label.configure(text="Guardar en:")
        self.out_ref_to_pp_folder_label.grid(column='0', row='5')

        self.out_ref_to_pp_folder_entry = ttk.Entry(self.ref_to_pp_frame)
        ...
        self.out_ref_to_pp_folder_button = ttk.Button(self.ref_to_pp_frame)
        ...
        self.ref_to_pp_config_button = ttk.Button(self.ref_to_pp_frame)
        ...
        self.ref_to_pp_main_button = ttk.Button(self.ref_to_pp_frame)
        ...
        self.out_textbox.configure(background='#dddddd', relief='flat',height='10',width='20',state='disabled')
