...
def antenna_to_grid(file_route, interpolate):
    with nc.Dataset(file_route, mode='a') as ds:
        #TODO fix sweep number
        data = ds['reflectivity'][:360]
        ran = ds['range'][:]
        ...
        lat = ds.createVariable('gridded_latitude', "f4", ('gridded_latitude',))
        lon = ds.createVariable('gridded_longitude', "f4", ('gridded_longitude',))
        ref = ds.createVariable('gridded_reflectivity', "f4", ('gridded_latitude', 'gridded_longitude'))
